...
async def handle_message(message: types.Message):
    ...
    KASPER_SYSTEM_PROMPT = (
        ...
        "твоего предыдущего ответа и т.п.), а не вопрос и не новый запрос — "
        "не выдумывай содержательный ответ не по теме, а просто отреагируй "
        "естественно на саму реакцию, коротко и по делу, без притягивания "
        "старых тем из истории переписки. "
